...
export default function Contact() {
  ...
  return (
    <>
      <Head>
        <title>Contact - PT. Medtro Medica Utama</title>
        <meta name="description" content="Learn more Contact PT. Medtro Medica Utama, our products, vision, mission, and contact information." />
      </Head>
      ...
      <div className={styles.contactPage}>
        ...
        <section className={styles.hero}>
          <div className="container">
            <h1 className={styles.heroTitle}>Kontak Kami</h1>
            <p>Kontak Perusahaan PT. Medtro Medica Utama</p>
          </div>
        </section>
