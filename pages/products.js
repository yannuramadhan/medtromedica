...
export default function Products() {
  ...
  return (
    <>
      <Head>
        <title>Products - PT. Medtro Medica Utama</title>
        <meta name="description" content="Learn more Products PT. Medtro Medica Utama, our products, vision, mission, and contact information." />
      </Head>
      ...
      <div className={styles.productPage}>
        ...
        <section className={styles.hero}>
          <div className="container">
            <h1 className={styles.heroTitle}>Produk Kami</h1>
            <p>Temukan produk PT. Medtro Medica Utama</p>
          </div>
        </section>
