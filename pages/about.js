...
export default function About() {
  ...
  return (
    <>
      <Head>
        <title>Tentang Kami - PT. Medtro Medica Utama</title>
        <meta name="description" content="Learn more about PT. Medtro Medica Utama, our products, vision, mission, and contact information." />
      </Head>
        ...
        <section className={styles.hero}>
          <div className="container">
            <div className={styles.heroContent}>
              <h1 className={styles.heroTitle}>Tentang PT. Medtro Medica Utama</h1>
              <p style={{ fontSize: '1.2rem', opacity: 0.9 }}>
                Medical devices manufacturer focused on producing the best products
              </p>
            </div>
          </div>
        </section>
